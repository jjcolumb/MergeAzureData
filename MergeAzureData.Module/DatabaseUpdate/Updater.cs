...
namespace MergeAzureData.Module.DatabaseUpdate;
...
public class Updater : ModuleUpdater {
    ...
    public override void UpdateDatabaseAfterUpdateSchema() {
        ...
        // Global Info
        if (ObjectSpace.GetObjectsCount(typeof(GlobalInfo), null) == 0)
        {
            GlobalInfo globalInfo = ObjectSpace.CreateObject<GlobalInfo>();
            globalInfo.ScopedCredential = "LiveDBQueryCredentials";
